...
bdnf_counts <-  read_excel(bdnf_file_path)
...
```{r}
path_to_meta_you_downloaded <-  file.path(here::here(),"data","trial_meta.csv") #update this
...
TAKE THE TOP  GENES ON THE 4SU  PC and do GO analysis
TAKE THE TOP GENES ON THE BDNF PC and do GO analysis
