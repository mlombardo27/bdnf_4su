...
switchPlotTopSwitches(switchAnalyzeRlist = switch_list_2hr_part2, 
            ...
            fileType = "pdf")
extractConsequenceSummary(switchAnalyzeRlist = switch_list_2hr_part2,
                          consequencesToAnalyze = c("tss","tts","last_exon","isoform_length","intron_retention","coding_potential","ORF_genomic","5_utr_length","3_utr_length","NMD_status","domains_identified","genomic_domain_position","domain_length","signal_peptide_identified","IDR_identified","IDR_length","IDR_type"),
                          removeEmptyConsequence= TRUE,
                plot = TRUE, returnResult = FALSE)
extractConsequenceEnrichment(switchAnalyzeRlist = switch_list_2hr_part2, consequencesToAnalyze = c("tss","tts","last_exon","isoform_length","intron_retention","coding_potential","ORF_genomic","5_utr_length","3_utr_length","NMD_status","domains_identified","genomic_domain_position","domain_length","signal_peptide_identified","IDR_identified","IDR_length","IDR_type"),
                plot = TRUE, returnResult = FALSE)
extractSplicingEnrichment(switchAnalyzeRlist = switch_list_2hr_part2, 
                plot = TRUE, returnResult = TRUE)
```
